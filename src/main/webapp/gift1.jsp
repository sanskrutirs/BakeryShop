...
<div class="top-area">
    ...
    <thead>
              ...
              <%  if(request.getParameter("category")!=null){
            	  String category = request.getParameter("category");
                     try
                     {
                      Connection con;
                      Statement stmt;
                      String sql="select prod_id,pname,image,category,price,desp from gift where category=?";
        ...
        <td><%=rs.getString(2) %></td>
         <td><img src="product/<%=rs.getString(3) %>" alt="Los Angeles" width="100" height="100"></td>
