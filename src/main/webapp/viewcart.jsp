      ...
      <div class="sidebar"">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
                        ...
                        <a class="active" href="viewcart.jsp"><h2>View Cart</h2></a>
			...
			<div> <div><%@include file="message.jsp"%></div></div>
                            <div class="panel" style="float: left;max-width: 700px">
           
           <div id = "editprofile" style="">
                  <div class="title" style="height:50px"> All My Bookings</div>
                  <br>
            ...
            <th scope="col">Status</th>
              ...
              <% 
                     try
                     {
                      Connection con;
                      Statement stmt;
                      String sql="select bid, bookdate,gid,price,quantity,total,status from booking where email=?";
          ...
          <td><%=rs.getString(2) %></td>
           <td><%=rs.getString(3) %></td>
            ...
            <td ><a  href="DelgiftServlet?id=<%=rs.getString(1) %>"
                ...
                <div class="delete-btn" style="max-width: 60px;font-size: 15px; padding: 3px">Cancel Booking</div>
            </a></td>
            </tr>
            <%
            }
